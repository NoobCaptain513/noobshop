...
public class JwtAuthenticationHandler {
    ...
    public Result<Object> handleUnauthenticatedException(Exception e, HttpServletRequest request){
        log.error("token 不存在: {} {} - {}", request.getMethod(), request.getRequestURI(), e.getMessage());
