...
import com.app.noobshop.common.constant.CaffeineConstant;
import com.app.noobshop.service.impl.CategoryServiceImpl;
import com.app.noobshop.service.impl.ProductSearchKeywordServiceImpl;
...
public class CaffeineConfig {
     ...
     */
    @Bean
    public LoadingCache<String, List<com.app.noobshop.pojo.entity.Category>> categoryTreeCache() {
        return Caffeine.newBuilder()
                .initialCapacity(1)
                .maximumSize(1)
                .build(new CacheLoader<>() {
                    @Override
                    public @Nullable List<com.app.noobshop.pojo.entity.Category> load(String key) throws IllegalArgumentException {
