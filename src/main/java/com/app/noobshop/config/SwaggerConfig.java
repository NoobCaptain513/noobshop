...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        Server testServer = new Server().url("http://test-api.noobshop.com").description("测试环境");
        ...
        return new OpenAPI()
                ...
                .info(new Info()
                        ...
                        .description("""
                                ...
                                """)
                        .contact(new Contact().name("后端研发组").email("dev@noobshop.com"))
                        .license(new License().name("内部使用").url("http://noobshop.com/license")))
