package com.app.noobshop.infrastructure.rocketmq.constant.coupon;
...
public class MqCouponConstant {
    ...
    //consumer group
    public static final String CONSUMER_GROUP_COUPON_UPDATE_STATUS = "coupon-status-consumer-group";
